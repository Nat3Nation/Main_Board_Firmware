...
/*Comm Verification Registers*/
#define LAST_CMD 0x4A3
#define LAST_DATA_16 0x4AC
#define LAST_DATA_32 0x423
#define RUN_REGISTER 0x480
...
{
  public:
    ADE9000(PCA9671BS *expander, int id = 0);
    void begin(void); 
    
    /*SPI Functions*/
    void SPI_Init(uint32_t SPI_speed ,uint8_t chipSelect_Pin, uint8_t en_val = LOW);    
    ...
    /*Method to read Config register*/
    int32_t ReadConfigRegisterValue();
